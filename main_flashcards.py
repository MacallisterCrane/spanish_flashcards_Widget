...
def next_card():
    ...
    canvas.itemconfig(word, text=f"{current_card['Spanish']}", fill="black")
...
try:
    ...
    word_data = pandas.read_csv("spanish_words.csv")
...
card_back_q = PhotoImage(file="card_front.png")
card_back_a = PhotoImage(file="card_back.png")
card = canvas.create_image(400, 263, image=card_back_q)
language = canvas.create_text(400, 150, text="Spanish", fill="black", font=("Arial", 40, "italic"))
